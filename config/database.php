    ...
    */
    ...
    'connections' => [
        ...
        'monitoring' => [
            'driver'         => 'mysql',
            'url'            => env('DB_URL'),
            'host'           => env('MONITORING_DB_HOST', '127.0.0.1'),
            'port'           => env('MONITORING_DB_PORT', '3306'),
            'database'       => env('MONITORING_DB_DATABASE', 'forge'),
            'username'       => env('MONITORING_DB_USERNAME', 'forge'),
